            ...
            <div class="row">
                <div class="col-lg-8 col-md-6">
                    <div class="subscribe-details">
                        ...
                        <h6 class="font-light">Subscribe to Blossom Buzz and stay updated with the latest news
                             about our fresh and fabulous products</h6>
                    </div>
                </div>
...
@push('scripts')
      <script>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.status == 200) {
                            ...
                            redirectToWishlist(); // Redirect to wishlist page after successful addition
                        }
                    }
                });
            }
            ...
            function redirectToWishlist() {
                window.location.href = '{{ route('wishlist.list') }}';
            }
