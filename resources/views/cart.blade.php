                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-4 col-sm-6 ">
                        <div class="checkout-button">
                            <a href="{{route('checkout.create')}}" class="btn btn-solid-default btn fw-bold">
                            ...
                            <div class="cart-box-details">
                                <div class="total-details">
                                    <div class="top-details">
                                        ...
                                        <h6>Tax <span>${{Cart::instance('cart')->tax()}}</span></h6> <h6>Total <span>${{Cart::instance('cart')->total()}}</span></h6>
                                    </div>
