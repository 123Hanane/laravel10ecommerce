                    ...
                    <div class="col-lg-12">
                        <div class="main-menu">
                                ...
                                <div class="main-navbar">
                                    <div id="mainnav">
                                        ...
                                        <ul class="nav-menu">
                                            ...
                                            <li><a href="{{route('contact.create')}}" class="nav-link menu-title">Contact Us</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="menu-right">
                                <ul>
                                    <li>
                                        <div class="search-box theme-bg-color" style="background-color:#e949a1;">
                                    ...
                                    <li class="onhover-dropdown" >
                                        <div class="cart-media name-usr" style="background-color:#e949a1;">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="footer-contact">
                            ...
                            <ul class="contact-lists" style="clear:both;">
                                <li>
                                    <span><b>phone:</b> <span class="font-light"> +21267909876543</span></span>
                                </li>
                                <li>
                                    <span><b>Address:</b><span class="font-light">Guelmim, Oued Noun</span></span>
                                </li>
                                <li>
                                    <span><b>Email:</b><span class="font-light">HDflowers@gmail.com</span></span>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="footer-links">
                            ...
                            <div class="footer-content">
                                <ul>
                                    ...
                                    <li>
                                        <a href="{{route('contact.create')}}"  class="font-dark">Contact</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
        ...
        <div class="sub-footer">
            <div class="container">
                <div class="row gy-3">
                    ...
                    <div class="col-md-6">
                        <p class="mb-0 font-dark">© 2024, HD flowers.</p>
                    </div>
                </div>
            </div>
        </div>
